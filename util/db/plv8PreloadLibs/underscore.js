...
(function() {
	...
	(m.flatten = function(n, t) {
		...
		m.isBoolean(t) || ((e = r), (r = t), (t = !1)), null != r &&
			(r = x(r, e));
	...
	(m.bind = function(n, t) {
		...
		var r;
		return function() {
			return --n > 0 && (r = t.apply(this, arguments)), 1 >= n &&
				(t = null), r;
		};
	...
	}), (m.noop = function() {}), (m.property = w), (m.propertyOf = function(
		n
	) {
		return null == n
			? function() {}
	...
	(m.mixin = function(n) {
		...
		function(n) {
			...
			m.prototype[n] = function() {
				var r = this._wrapped;
				return t.apply(r, arguments), ("shift" !== n &&
					"splice" !== n) ||
					0 !== r.length ||
					delete r[0], P(this, r);
			};
